...
class CountDownText extends Component {
  ...
  componentWillReceiveProps(nextProps) {
    console.log(this.props.endTime, 'disabled123');
    let updating = true;
    ...
    if (updating && !this.props.disabled) {  // 注意死循环 this.props.disabled
      console.log(updating,'updating', this.props.disabled);
      // 重置： 清空计数 + 停止计时
      this.counter.reset();
